...
This project is refactored from the original [**portfolio**](https://github.com/ArielFalcon/portfolio) project, thanks for his work.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/fr0ziii/portfolio&project-name=portfolio&repository-name=portfolio)
...
```bash
pnpm create astro@latest --template fr0ziii/portfolio
```
...
```bash
git clone https://github.com/fr0ziii/portfolio.git
cd portfolio
pnpm install
```
